...
class BaseBBO(Root):
    ...
    def __init__(self, obj_func=None, lb=None, ub=None, verbose=True, epoch=750, pop_size=100, p_m=0.01, elites=2, random_seed=None, **kwargs):
    ...
    def train(self, filename, epoch_count=0, v_list=None, pop=None):
        if epoch_count == 0:
