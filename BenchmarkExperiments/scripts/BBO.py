...
class BaseBBO(Root):
    ...
    def __init__(self, obj_func=None, lb=None, ub=None, verbose=True, epoch=750, pop_size=100, p_m=0.2, elites=2, random_seed=None, terminal_value = None, **kwargs):
    ...
    def train(self, filename, data=None, epoch_count=0, v_list=None, pop=None):
        ...
        for epoch in range(epoch_count, self.epoch):
            ...
            self.best_function = pop_elites[self.ID_MIN_PROB][self.ID_FIT]
