...
from geneticalgorithm1_const_failed import geneticalgorithm1_const_failed as ga1
...
# print(varbound)
min = test.min_search_range[0]
max = test.max_search_range[0]
...
# before = time.time()
model2=ga1(function=obj_func,dimension=dimension,variable_type='real',variable_boundaries=varbound, random_seed=rand_var, algorithm_parameters=algorithm_param, convergence_curve=False)
